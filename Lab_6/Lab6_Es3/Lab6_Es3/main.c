...
//                linear_search(elrif6,num_righe, stringa);
                ...
                break;
            case 7:
                printf("Inserire nome file che si vuole leggere: ");
                scanf("%s", name_file);
                fp=fopen(name_file, "r");
                fscanf(fp, "%d", &num_righe);
                
                v=(Riga*) realloc(v, num_righe*sizeof(Riga));
                ...
                elrif2 = (Riga**)realloc(elrif2, num_righe*sizeof(Riga*));
                elrif3 = (Riga**)realloc(elrif3, num_righe*sizeof(Riga*));
                elrif4 = (Riga**)realloc(elrif4, num_righe*sizeof(Riga*));
                elrif5 = (Riga**)realloc(elrif5, num_righe*sizeof(Riga*));
                elrif6 = (Riga**)realloc(elrif6, num_righe*sizeof(Riga*));
...
void binary_search(Riga** elrif, int l, int r, char* tbs){
    ...
    if(strcmp(elrif[m]->partenza, tbs)>0){
